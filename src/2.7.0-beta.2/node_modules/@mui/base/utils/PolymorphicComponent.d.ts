 ...
 */
export type PolymorphicProps<TypeMap extends OverridableTypeMap, RootComponent extends React.ElementType> = TypeMap['props'] & Omit<React.ComponentPropsWithRef<RootComponent>, keyof TypeMap['props']>;
